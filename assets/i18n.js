...
const I18N = {
  ...
  kn: {
    ...
    hero_sub:"RAAYA ನಾಯಕರು, ಅಭ್ಯರ್ಥಿಗಳು ಮತ್ತು ರಾಜಕೀಯ ಸಂಘಟನೆಗಳಿಗೆ ಮತದಾರರನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳಲು, ನಿರೂಪಣೆ ರೂಪಿಸಲು, ಸಾರ್ವಜನಿಕ ವಿಶ್ವಾಸ ಕಟ್ಟಲು ಮತ್ತು ಶಿಸ್ತುಬದ್ಧ ಪ್ರಚಾರ ನಡೆಸಲು ಸಹಾಯ ಮಾಡುತ್ತದೆ — ಡೇಟಾ, ತಳಮಟ್ಟದ ಮಾಹಿತಿ, ಡಿಜಿಟಲ್ ಪ್ರಭಾವ ಮತ್ತು ಬೂತ್-ಮಟ್ಟದ ಕಾರ್ಯತಂತ್ರದ ಮೂಲಕ.",

    stat1_n:"31", stat1_l:"ಕರ್ನಾಟಕದ ಮ್ಯಾಪ್ ಮಾಡಿದ ಜಿಲ್ಲೆಗಳು",
    stat2_n:"360°", stat2_l:"ಡೇಟಾ · ನಿರೂಪಣೆ · ಡಿಜಿಟಲ್ · ತಳಮಟ್ಟ",
    ...
    prob1_h:"ತಳಮಟ್ಟದ ವಾಸ್ತವ ಚದುರಿದೆ", prob1_p:"ಪ್ರತಿ ಬೂತ್, ವಾರ್ಡ್ ಮತ್ತು ಸಮುದಾಯ ಬೇರೆ ಬೇರೆ. ಸೂಕ್ಷ್ಮ ಮಾಹಿತಿ ಇಲ್ಲದೆ ಪ್ರಚಾರಗಳು ತಪ್ಪು ಸ್ಥಳದಲ್ಲಿ ಶಕ್ತಿ ವ್ಯಯಿಸುತ್ತವೆ.",
    ...
    prob3_h:"ಸಂಘಟನೆ ಮತದಾನ ನಿರ್ಧರಿಸುತ್ತದೆ", prob3_p:"ಕಾರ್ಯಶೀಲ ಬೂತ್ ರಚನೆ ಇಲ್ಲದೆ ಉತ್ಸಾಹ ಮತದಾನದ ದಿನ ಮತವಾಗಿ ಪರಿವರ್ತನೆಯಾಗದು.",
    ...
    svc_p:"ತಳಮಟ್ಟ ಆಲಿಸುವುದರಿಂದ ಗೆಲುವಿನ ಜನಾದೇಶ ಮತ್ತು ಬಾಳಿಕೆ ಬರುವ ವಿಶ್ವಾಸದವರೆಗೆ ಪ್ರಚಾರವನ್ನು ಕೊಂಡೊಯ್ಯುವ ಆರು ಸಂಯೋಜಿತ ಸಾಮರ್ಥ್ಯಗಳು.",
    svc1_h:"RAAYA ಗ್ರೌಂಡ್ ಪಲ್ಸ್", svc1_p:"ಮತದಾರ ಸಂಶೋಧನೆ, ಸ್ಥಳೀಯ ಸಮಸ್ಯೆ ಅನ್ವೇಷಣೆ, ಜನಭಾವನೆ, ಬೂತ್-ಮಟ್ಟದ ಮಾಹಿತಿ ಮತ್ತು ಕ್ಷೇತ್ರ ರೋಗನಿರ್ಣಯ.",
    svc2_h:"ಕ್ಯಾಂಡಿಡೇಟ್ ಬ್ಲೂಪ್ರಿಂಟ್", svc2_p:"ಅಭ್ಯರ್ಥಿ ಚಿತ್ರಣ ವಿಶ್ಲೇಷಣೆ, ನಾಯಕತ್ವ ಸ್ಥಾನೀಕರಣ, ವೈಯಕ್ತಿಕ ನಿರೂಪಣೆ ಮತ್ತು ವಿಶ್ವಾಸ ಕಾರ್ಯತಂತ್ರ.",
    svc3_h:"ಕ್ಯಾಂಪೇನ್ ಕಮಾಂಡ್", svc3_p:"ಪೂರ್ಣ ಪ್ರಚಾರ ಯೋಜನೆ, ಕ್ಷೇತ್ರ ಅನುಷ್ಠಾನ, ತಂಡ ರಚನೆ, ದೈನಂದಿನ ನಿಗಾ ಮತ್ತು ಬೂತ್-ಮಟ್ಟದ ಸಮನ್ವಯ.",
    svc4_h:"ಡಿಜಿಟಲ್ ಮ್ಯಾಂಡೇಟ್", svc4_p:"ಸಾಮಾಜಿಕ ಕಾರ್ಯತಂತ್ರ, ವಾಟ್ಸಾಪ್ ಪ್ರಚಾರ, ಕಿರು ವೀಡಿಯೊ, ಡಿಜಿಟಲ್ ಪ್ರತಿಷ್ಠೆ ಮತ್ತು ಪ್ರಾದೇಶಿಕ-ಭಾಷಾ ವಿಷಯ.",
    ...
    svc6_h:"ಗವರ್ನೆನ್ಸ್ ಕನೆಕ್ಟ್", svc6_p:"ಚುನಾವಣೆ ನಂತರದ ಅಭಿವೃದ್ಧಿ ಸಂವಹನ, ಸಾಧನೆ ಬ್ರ್ಯಾಂಡಿಂಗ್ ಮತ್ತು ದೀರ್ಘಕಾಲೀನ ಪ್ರತಿಷ್ಠೆ ನಿರ್ಮಾಣ.",

    fw_k:"ನಮ್ಮ ವಿಧಾನ", fw_h:"R.A.A.Y.A. ವಿಧಾನ.",
    fw_p:"ತಳಮಟ್ಟ ಆಲಿಸುವುದರಿಂದ ಕಾರ್ಯತಂತ್ರ ರೂಪಿಸಿ, ಅದನ್ನು ದೈನಂದಿನ ಅನುಷ್ಠಾನ ಮತ್ತು ಶಾಶ್ವತ ಅಧಿಕಾರವಾಗಿ ಪರಿವರ್ತಿಸುವ ಶಿಸ್ತುಬದ್ಧ ಚಕ್ರ.",
    ...
    fw3_h:"ರಚನೆ", fw3_p:"ಸಂದೇಶ, ತಂಡ, ಬೂತ್ ಯೋಜನೆ, ಡಿಜಿಟಲ್ ಯೋಜನೆ ಮತ್ತು ಕ್ಯಾಲೆಂಡರ್.",
    fw4_h:"ಫಲ", fw4_p:"ಸಂಪರ್ಕ, ರ‍್ಯಾಲಿಗಳು, ಡಿಜಿಟಲ್ ಪ್ರಭಾವ ಮತ್ತು ದೈನಂದಿನ ನಿಗಾ.",
    ...
    why1:"<b>ಭಾರತೀಯ ತಳಮಟ್ಟದ ವಾಸ್ತವಕ್ಕೆ ನಿರ್ಮಿತ.</b> ಬೂತ್, ವಾರ್ಡ್, ಪಂಚಾಯತ್ ಮತ್ತು ಸಮುದಾಯ ಪರಿಚಯ — ಆಮದು ಮಾಡಿದ ತಂತ್ರವಲ್ಲ.",
    why2:"<b>ಡೇಟಾ-ಆಧಾರಿತ, ಊಹೆಯಲ್ಲ.</b> ಪ್ರತಿ ನಿರ್ಧಾರದ ಹಿಂದೆ ದ್ವಿಭಾಷಾ ಭಾವನಾ ಮಾಹಿತಿ ಮತ್ತು ಜಿಲ್ಲಾವಾರು ರೋಗನಿರ್ಣಯ.",
    ...
    conf_p:"ಎಲ್ಲಾ ಕಾರ್ಯತಂತ್ರ ಚರ್ಚೆಗಳು, ಕ್ಷೇತ್ರ ಡೇಟಾ, ಪ್ರಚಾರ ಯೋಜನೆಗಳು, ಮತದಾರ ಸಂಶೋಧನೆ ಮತ್ತು ಆಂತರಿಕ ಮೌಲ್ಯಮಾಪನಗಳನ್ನು ಕಟ್ಟುನಿಟ್ಟಿನ ಗೌಪ್ಯತೆಯಿಂದ ನಿರ್ವಹಿಸಲಾಗುತ್ತದೆ. ಲಿಖಿತ ಅನುಮತಿ ಇಲ್ಲದೆ RAAYA ಯಾವುದೇ ಮೂರನೇ ವ್ಯಕ್ತಿಗೆ ಮಾಹಿತಿ ಬಹಿರಂಗಪಡಿಸುವುದಿಲ್ಲ.",
    ...
    foot_about:"ಪ್ರೀಮಿಯಂ ರಾಜಕೀಯ ಕಾರ್ಯತಂತ್ರ ನಿರ್ವಹಣಾ ಸಂಸ್ಥೆ — ಮತದಾರ ಮಾಹಿತಿ, ನಿರೂಪಣೆ, ಡಿಜಿಟಲ್ ಪ್ರಭಾವ ಮತ್ತು ತಳಮಟ್ಟದ ಅನುಷ್ಠಾನ.",
    ...
    sv_hero_h:"ಭಾರತೀಯ ತಳಮಟ್ಟದ ವಾಸ್ತವಕ್ಕೆ ನಿರ್ಮಿತ ಸೇವೆಗಳು.",
    sv_hero_p:"ತಳಮಟ್ಟ ಆಲಿಸುವುದರಿಂದ ನಿರೂಪಣೆ ಮತ್ತು ಶಿಸ್ತುಬದ್ಧ ಅನುಷ್ಠಾನದವರೆಗೆ — ಆರು ಪ್ರಮುಖ ಸಾಮರ್ಥ್ಯಗಳು ಮತ್ತು ಕೆಲವರೇ ಅನುಷ್ಠಾನಗೊಳಿಸಿದ ಫ್ಲಾಗ್‌ಶಿಪ್ ಮಾಹಿತಿ ಸೇವೆಗಳು.",
    sd_li:"ಒಳಗೊಂಡಿದೆ:",
    sd1_li:"<li>ಬೂತ್ ಮತ್ತು ವಾರ್ಡ್-ಮಟ್ಟದ ಮತದಾರ ಸಮೀಕ್ಷೆ</li><li>ಸ್ಥಳೀಯ ಸಮಸ್ಯೆ ಮತ್ತು ಕುಂದುಕೊರತೆ ಮ್ಯಾಪಿಂಗ್</li><li>ಸಮುದಾಯ ಪ್ರಭಾವ ಗ್ರಿಡ್</li><li>ಕ್ಷೇತ್ರ ರೋಗನಿರ್ಣಯ ವರದಿ</li>",
    ...
    sd3_li:"<li>ಬೂತ್ ಮತ್ತು ಶಕ್ತಿ ಕೇಂದ್ರ ರಚನೆ</li><li>ಸ್ವಯಂಸೇವಕ ತರಬೇತಿ ಮತ್ತು ಕಾರ್ಯ ಹಂಚಿಕೆ</li><li>ದೈನಂದಿನ ವರದಿ ಮತ್ತು ಪರಾಮರ್ಶೆ</li><li>ರ‍್ಯಾಲಿ ಮತ್ತು ಪಾದಯಾತ್ರೆ ಯೋಜನೆ</li>",
    ...
    sd6_li:"<li>ಸಾಧನೆ ಮತ್ತು ಅಭಿವೃದ್ಧಿ ಸಂವಹನ</li><li>ಜನಸೇವಾ ಸಂದೇಶ</li><li>ಆಡಳಿತ ಸ್ಕೋರ್‌ಕಾರ್ಡ್</li><li>ದೀರ್ಘಕಾಲೀನ ಪ್ರತಿಷ್ಠೆ ನಿರ್ಮಾಣ</li>",
    fl_k:"ಫ್ಲಾಗ್‌ಶಿಪ್ ಇಂಟೆಲಿಜೆನ್ಸ್", fl_h:"ಬಹುತೇಕ ಸಂಸ್ಥೆಗಳು ಅನುಷ್ಠಾನಗೊಳಿಸದ ಕಲ್ಪನೆಗಳು.",
    fl_p:"ಆಲಿಸುವಿಕೆಯನ್ನು ಗೋಚರ ಕ್ರಿಯೆಯಾಗಿ ಪರಿವರ್ತಿಸುವ ಕಾರ್ಯಸಾಧ್ಯ, ನೈತಿಕ ಮತ್ತು IP-ಆಧಾರಿತ ಸೇವೆಗಳು.",
    fl1_h:"ಕ್ಷೇತ್ರ ಡಿಜಿಟಲ್ ಟ್ವಿನ್", fl1_p:"ತಳಮಟ್ಟದಲ್ಲಿ ಖರ್ಚು ಮಾಡುವ ಮೊದಲು ಸನ್ನಿವೇಶಗಳನ್ನು ಅಭ್ಯಾಸಿಸಲು ಕ್ಷೇತ್ರದ ಜೀವಂತ ಡೇಟಾ ಮಾದರಿ.",
    ...
    fl3_h:"ಸೆಂಟಿಮೆಂಟ್-ಟು-ಆಕ್ಷನ್ ಲೂಪ್", fl3_p:"ದೈನಂದಿನ ಜಿಲ್ಲಾ ಭಾವನೆಯಿಂದ ಕ್ಷೇತ್ರ-ಕ್ರಿಯಾ ಪಟ್ಟಿ; ಮರುದಿನ ಪರಿಣಾಮ ಅಳೆಯುತ್ತದೆ.",
    fl4_h:"ನಿರೂಪಣಾ ವಾರ್-ಗೇಮಿಂಗ್", fl4_p:"ವಿರೋಧದ ಸಂಭಾವ್ಯ ದಾಳಿಗಳನ್ನು ಅನುಕರಿಸಿ ವಾಸ್ತವ-ಆಧಾರಿತ ಪ್ರತ್ಯುತ್ತರ ಮೊದಲೇ ಸಿದ್ಧಪಡಿಸಿ.",
    fl5_h:"ವಲಸೆ ಮತ್ತು ಡಯಾಸ್ಪೊರಾ ಮತದಾರರು", fl5_p:"ನಗರ ಮತ್ತು ವಿದೇಶದಲ್ಲಿ ದುಡಿಯುವ ಮತದಾರರೊಂದಿಗೆ ಸಂಪರ್ಕಿಸಿ ತವರು ಕ್ಷೇತ್ರದ ಅಭಿಪ್ರಾಯ ಪ್ರಭಾವಿಸಿ.",

    ap_hero_h:"ಶಿಸ್ತುಬದ್ಧ ವಿಧಾನ, ಊಹೆಯಲ್ಲ.",
    ap_hero_p:"RAAYA ದ ಪ್ರತಿ ಕೆಲಸ R.A.A.Y.A. ವಿಧಾನದ ಮೇಲೆ ನಡೆಯುತ್ತದೆ — ತಳಮಟ್ಟ ಸಂಶೋಧನೆಯಿಂದ ಶಾಶ್ವತ ಸಾರ್ವಜನಿಕ ಅಧಿಕಾರದವರೆಗಿನ ಪುನರಾವರ್ತನೀಯ ಚಕ್ರ.",
    ap1_h:"ಸಂಶೋಧನೆ", ap1_p:"ನಾವು ಕ್ಷೇತ್ರದಿಂದ ಆರಂಭಿಸುತ್ತೇವೆ: ಜನ, ಸಮಸ್ಯೆ, ಭಾವನೆ, ಸಮುದಾಯ, ಸ್ಥಳೀಯ ನಾಯಕತ್ವ ಮತ್ತು ಜನಭಾವನೆ — ಬೂತ್ ಮಟ್ಟದವರೆಗೆ.",
    ...
    ap3_h:"ರಚನೆ", ap3_p:"ನಾವು ಪ್ರಚಾರ ರಚನೆ ಕಟ್ಟುತ್ತೇವೆ: ಸಂದೇಶ, ತಂಡ, ಬೂತ್ ಯೋಜನೆ, ಡಿಜಿಟಲ್ ಯೋಜನೆ, ನಾಯಕ ಸ್ಥಾನ ಮತ್ತು ದಿನ-ದಿನದ ಅನುಷ್ಠಾನ ಕ್ಯಾಲೆಂಡರ್.",
    ...
    ap_out_k:"ನಾವು ಹೇಗೆ ವರದಿ ನೀಡುತ್ತೇವೆ", ap_out_h:"ಸ್ಪಷ್ಟ, ಉಪಯುಕ್ತ, ಕ್ಷೇತ್ರ-ಸಿದ್ಧ ಔಟ್‌ಪುಟ್.",
    ...
    ap_out2_h:"ಕ್ಷೇತ್ರ ಸ್ವರೂಪಗಳು", ap_out2_p:"ಸಮೀಕ್ಷೆ ಟೆಂಪ್ಲೇಟ್, ಬೂತ್ ಟ್ರ್ಯಾಕರ್, ದೈನಂದಿನ ವರದಿ ಸ್ವರೂಪ ಮತ್ತು ಸ್ವಯಂಸೇವಕ ಕಾರ್ಯ-ಹಾಳೆಗಳು.",
    ...
    ab_hero_p:"RAAYA ಗಂಭೀರ ಕಾರ್ಯತಂತ್ರ ಬಯಸುವ ನಾಯಕರಿಗಾಗಿ — ಯಾದೃಚ್ಛಿಕ ಪ್ರಚಾರಕ್ಕಲ್ಲ — ಒಂದು ಪ್ರೀಮಿಯಂ ರಾಜಕೀಯ ಕಾರ್ಯತಂತ್ರ ನಿರ್ವಹಣಾ ಸಂಸ್ಥೆ.",
    ab_long_h:"ನಾವು ಯಾರು",
    ...
    ab_long_p2:"ನಾವು ಕ್ಷೇತ್ರದಿಂದ ಆರಂಭಿಸುತ್ತೇವೆ — ಜನ, ಸಮಸ್ಯೆ, ಭಾವನೆ, ಸಮುದಾಯ, ಸ್ಥಳೀಯ ನಾಯಕತ್ವ ಮತ್ತು ಜನಭಾವನೆ. ಅಲ್ಲಿಂದ ಅಭ್ಯರ್ಥಿ ಸ್ಥಾನ, ಮತದಾರ ಸಂಪರ್ಕ, ಬೂತ್ ಯೋಜನೆ, ನಿರೂಪಣೆ, ಡಿಜಿಟಲ್ ಪ್ರಭಾವ, ಮಾಧ್ಯಮ ಪ್ರತಿಕ್ರಿಯೆ ಮತ್ತು ದೈನಂದಿನ ನಿಗಾ ಒಳಗೊಂಡ ಪೂರ್ಣ ಕಾರ್ಯತಂತ್ರ ರೂಪಿಸುತ್ತೇವೆ.",
    ...
    ct_note:"ಈ ಫಾರ್ಮ್ ವಿವರಗಳೊಂದಿಗೆ ನಿಮ್ಮ ಇಮೇಲ್ ಆ್ಯಪ್ ತೆರೆಯುತ್ತದೆ — ಈ ಸೈಟ್‌ನಲ್ಲಿ ಯಾವ ಡೇಟಾವೂ ಸಂಗ್ರಹವಾಗುವುದಿಲ್ಲ."
  }
};
